...
Services are offered by the CLIMAAX project to support climate risk assessments following the Framework and utilizing the workflows in this handbook.

:::{admonition} Public and exclusive services
:class: note
...
To use the services described below, registering at ECMWF is necessary.
...
Technical assistance for the JupyterHub service is provided through the service desk as described above.
